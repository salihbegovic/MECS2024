...
%% ======== required inputs ========
	...
	%% ====== title page ======
	\title{Excited state dynamics: first steps and outlook}											%% Presentation Title
...
%	\subtitle{Subtitle}                   					%% (optional) Subtitle, comment out to avoid include
	\newcommand{\authorText}{Faruk Salihbegovi\'c, Michael Sahre, Georg Kresse}				%% (optional) Author
...
%	\newcommand{\textFooter}{Footer text (author, presentation title, version, etc.)} %% (optional) Text for footline, e.g. title, comment out lines to avoid include, max. 1 line
	...
	\date{October 2024}              									%% Date, comment out to get current date
